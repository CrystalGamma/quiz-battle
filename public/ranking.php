...
<tbody><?php foreach($array['players'] as $idx => &$player) { ?><tr><td><?=$player['ranking']?>.<th><a class=player href="<?=$player['']?>"><?=htmlspecialchars($player['name'], ENT_QUOTES, 'utf-8')?><td><?=$player['points']?><?php } ?></tbody>
</table>

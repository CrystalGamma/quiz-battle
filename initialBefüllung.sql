...
Insert into spiel(einsatz, dealer, runden, fragen_pro_runde,	fragenzeit, rundenzeit, status) values(1,1,2,3,4,5,'beendet'),(6,1,7,8,9,10,'laufend'),(11,1,12,13,14,15,'ungestartet');
